            ...
            <v-card>
                <v-container>
                   <v-form @submit.prevent="addEvent"> 
                       ...
                       <v-text-field 
                            type="text" label="Add details" v-model="details">
                       </v-text-field>
                       <v-text-field 
                       ...
                       @click.stop="dialog = false">Add</v-btn>
                   </v-form>
                </v-container>
            </v-card>
        </v-dialog>
...
import { db } from '../main'
  ...
  export default {
    data: () => ({
      today: new Date().toISOString().substr(0,10),// today calendar
    ...
    mounted () { // just when the component is monted
    ...
    methods: {
        ...
        editEvent(id){ // here not async beacouse we're not calling db
